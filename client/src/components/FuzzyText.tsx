...
function __OriginkitBase_FuzzyText({
    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            // Using smaller horizontal margin to not overflow the flex container so heavily
            const horizontalMargin = fuzzRange + 5; 
...
const __originkitPresetProps = {
  font: {
    fontFamily: "'Apex MK2', sans-serif",
    fontWeight: 700,
    fontSize: "18px",
...
export default function FuzzyText(props: FuzzyTextProps) {
  return <__OriginkitBase_FuzzyText {...__originkitPresetProps} {...props} />;
}
